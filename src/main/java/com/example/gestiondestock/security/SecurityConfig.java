...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.cors().and().csrf().disable()
                ...
                .requestMatchers(HttpMethod.GET, "/all_categories").hasAuthority("list_categorie")
                .requestMatchers(HttpMethod.GET, "http://localhost:8080/api/utilisateur/All-user").hasAuthority("get_all_user")
