package com.example.gestiondestock.configration;
...
import com.example.gestiondestock.repository.PermissionRepository;
...
public class PermissionInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        String[] perm_list = { "get_all_user", "list_categorie", "list_role", "view_role", "create_role", "update_role", "delete_role",
